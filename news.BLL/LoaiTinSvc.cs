...
namespace news.BLL
{
    ...
    public class LoaiTinSvc: GenericSvc<LoaiTinRep, LoaiTin>
    {
        ...
        //moi tinh
        public SingleRsp DeleteLoaiTin(LoaiTinReq lt)
        {
            var res = new SingleRsp();
            LoaiTin loaitin = new LoaiTin();
            loaitin.Idloaitin = lt.Idloaitin;
            loaitin.TenLt = lt.TenLt;
            loaitin.ThutuLt = lt.ThutuLt;
            loaitin.AnhienLt = lt.AnhienLt;
            loaitin.Idtheloai = lt.Idtheloai;
            res = _rep.DeleteLoaiTin(loaitin);
            return res;
